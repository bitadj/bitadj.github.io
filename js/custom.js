 ...
 $("input,textarea").jqBootstrapValidation(
    {
     ...
     submitSuccess: function($form, event) {
      event.preventDefault(); // prevent default submit behaviour
       ...
       var email_link = $("<a href='mailto:bitadjaghouri@gmail.com?Subject=Message_Me;'>bitadjaghouri@gmail.com</a>")
 		...
 		// Fail message
 		 $('#success').html("<div class='alert alert-danger'>");
            	$('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
            	 .append( "</button>");
            	$('#success > .alert-danger').append("<strong>Sorry "+first_name+" it seems that my mail server is not responding...</strong> Please email me directly at <a href='mailto:bitadjaghouri@gmail.com?Subject=Hello!'>bitadjaghouri@gmail.com</a>? Sorry for the inconvenience!");
